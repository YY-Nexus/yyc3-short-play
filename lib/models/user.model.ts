...
export async function findUserById(id: number): Promise<User> {
  ...
  console.log("[v0] findUserById: 查询ID =", id)
  console.log("[v0] findUserById: 查询结果 =", Array.isArray(rows) && rows.length > 0 ? "找到用户" : "用户不存在")
...
export async function findUserByPhone(phone: string): Promise<User | null> {
  ...
  console.log("[v0] findUserByPhone: 查询手机号 =", phone)
  console.log("[v0] findUserByPhone: 查询结果 =", Array.isArray(rows) && rows.length > 0 ? "找到用户" : "用户不存在")
...
export async function findUserByEmail(email: string): Promise<User | null> {
  ...
  console.log("[v0] findUserByEmail: 查询邮箱 =", email)
  console.log("[v0] findUserByEmail: 查询结果 =", Array.isArray(rows) && rows.length > 0 ? "找到用户" : "用户不存在")
